...
var Elm = {};
Elm['Algo'] = Elm['Algo'] || {};
Elm['Algo']['PrimeAlgo'] = Elm['Algo']['PrimeAlgo'] || {};
if (typeof _user$project$Algo_PrimeAlgo$main !== 'undefined') {
    _user$project$Algo_PrimeAlgo$main(Elm['Algo']['PrimeAlgo'], 'Algo.PrimeAlgo', undefined);
}
